...
val mockMarkets = listOf(
    Market(
        ...
        coupons = 10,
//        rules = listOf(
//            Rule(id= "1", description = "Válido até dia 30/12", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4"),
//            Rule(id= "2", description = "Válido para consumo no local", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4"),
//        ),
